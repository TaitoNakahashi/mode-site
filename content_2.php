...
$level = '';
//使用するcssを記入
$css = '<link rel="stylesheet" href="'.$level.'css/cont2.css" type="text/css">';
                                ...
                                <div class="slide_right">
                                    <div class="mannequin cfx">
                                        <p class="mannequin__image">
                                            <img class="mannequin__image__left" src="images/concept/cloth-image3.png" alt="">
                                        </p>
                                        <p class="mannequin__image">
                                            <img class="mannequin__image__right" src="images/concept/cloth-image4.png" alt="">
                                        </p>
                                    </div>
